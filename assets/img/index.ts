// 명명규칙은 xxxxImg로 통일
export { default as ChromeWebstoreImg } from './chrome-webstore.png';
export { default as GoogleLoginImg } from './google-login.png';
...
export { default as LandingPageImg } from './web_main.png';
export { default as ArrowImg } from './arrow.png';
export { default as mobileBackgroundImg } from './mobile_main.png';
export { default as speechBubbleImg } from './speech bubble.png';
export { default as FaceImg } from './face.png';
